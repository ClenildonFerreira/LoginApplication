...
import io.github.clenildonferreira.devtechnicaltestapi.jwt.JwtToken;
import io.github.clenildonferreira.devtechnicaltestapi.web.dto.UserLoginDto;
...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("invalido@email.com", "123456098767"))
                .exchange()
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserLoginDto("ana@email.com", "00000000"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
